 ...
 * Generated at: 2017-10-25 23:08:32 UTC
...
public final class ajax_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /common/rs/ajax.jsp(25,0) name = baseName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fbundle_005f0.setBaseName("org.jboss.dashboard.ui.messages");
        // /common/rs/ajax.jsp(25,0) name = locale type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.print(AjaxRefreshManager.lookup().getMaxAjaxRequests());
      out.write(";\n");
      out.write("var value;\n");
      out.write("var ajaxedElements=[];\n");
      out.write("var ajaxedRefreshElements=[];\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("/**\n");
      out.write(" * Loads a given url into element with id tagId. If a body is specified, it uses multipart content-type to POST to the url.\n");
      out.write(" */\n");
      out.write("function doAjaxRequest(url, body, tagId, onAjaxRequestScript, onAjaxResponseScript) {\n");
      ...
      out.print(UIServices.lookup().getUrlMarkupGenerator().getBaseURI());
      out.write("';\n");
      out.write("                } else {\n");
      ...
      out.write("                    var rText = ajaxHandler.ajaxReq.responseText;\n");
      out.write("                    // JBPM-4369 - Fixing IE9 bug that create whitespaces bewtween td elements that produce table column's offsets.\n");
      out.write("                    var expr = new RegExp('>[ \\t\\r\\n\\v\\f]*<', 'g');\n");
      out.write("                    newElement.innerHTML = rText.replace(expr, '><');\n");
      ...
      out.write("\n");
      out.write("                    // Move 'script' elements into the 'head' section to avoid issues with some browsers which ignore them.\n");
      ...
      out.write("                    }\n");
      out.write("                    // Remove the 'script' elements once moved.\n");
      out.write("                    for(var i=0; i < ob.length; i++){\n");
      ...
      out.write("        ajaxedElements=[];\n");
      out.write("        ajaxedRefreshElements=[];\n");
      ...
      out.write("', component );\n");
      out.write("    setFormInputValue(form, '");
      out.print(FactoryURL.PARAMETER_ACTION);
      out.write("', property );\n");
      out.write("    setFormInputValue(form, '");
      ...
      out.write("                eval(\"ret = doAjaxRequest('\" + destination + \"&ajaxAction=true', null, '\" + targetId + \"', '\" + onAjaxRequestScript + \"', '\" + onAjaxResponseScript + \"')\");\n");
      out.write("                element=null;\n");
      ...
      out.write("            var formAction = element.action;\n");
      out.write("\n");
      out.write("            // Double click control.\n");
      out.write("            if (element) {\n");
      out.write("                element.onsubmit = function() {\n");
      ...
      out.write("                // Check max consecutive ajax request.\n");
      out.write("                if (ajaxRequestNumber >= ajaxMaxRequestNumber) return true;\n");
      out.write("                eval(\"ret = doAjaxRequest(formAction?formAction:'");
      out.print(UIServices.lookup().getUrlMarkupGenerator().getServletMapping());
      out.write("', getFormBody(this, true), '\" + targetId + \"', '\" + onAjaxRequestScript + \"', '\" + onAjaxResponseScript + \"');\");\n");
      out.write("                return ret;\n");
      out.write("            } else {\n");
      out.write("                element=null;\n");
      out.write("                return false;\n");
      ...
      out.write("};\n");
      out.write("\n");
      out.write("function isAjaxed(elementId) {\n");
      out.write("    if (!elementId) return false;    \n");
      out.write("    for (var i = 0; i < ajaxedElements.length; i++) {\n");
      out.write("        if(ajaxedElements[i]==elementId) return true;\n");
      out.write("    }\n");
      out.write("    return false;\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("    if (!isAjaxed(elementId)) {\n");
      out.write("        setTimeout(\"doSetAjax('\" + elementId + \"', null, null)\", 1);\n");
      out.write("        ajaxedElements.push(elementId);\n");
      out.write("    }\n");
      out.write("};\n");
      out.write("\n");
      ...
      out.write("};\n");
      out.write("\n");
      out.write("function isRefreshApplied(elementId) {\n");
      out.write("    if (!elementId) return false;\n");
      out.write("    for (var i = 0; i < ajaxedRefreshElements.length; i++) {\n");
      out.write("        if(ajaxedRefreshElements[i]==elementId) return true;\n");
      out.write("    }\n");
      out.write("    return false;\n");
      out.write("}\n");
      out.write("\n");
      ...
      out.write("    if (id) {\n");
      out.write("        if (!isRefreshApplied(id)) { \n");
      out.write("            setTimeout(\"doRefreshPanel('\"+ id + \"')\",10);\n");
      out.write("            ajaxedRefreshElements.push(id)\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("};\n");
      out.write("\n");
      ...
      out.write("        },\n");
      out.write("        onStart: function(draggable, event){\n");
      out.write("            // Bug fixing for IE9 and IE10. See https://prototype.lighthouseapp.com/projects/8887/tickets/343-ie9-triggers-ondragmousemove-event-when-clicking-a-draggable\n");
      out.write("            // The timeout must be over 200ms. Otherwise, the click event for a draggable region is not read and there is no page change.\n");
      out.write("            doDraggableTimeout = setTimeout('showPanelDropZones();showRegionDropZones(); clearTimeout(doDraggableTimeout); doDraggableTimeout = null;',200);\n");
      out.write("        },\n");
      out.write("        onEnd: function(draggable, event){\n");
      ...
      out.write("\tvar height = element.getHeight();\n");
  ...
  private boolean _jspx_meth_i18n_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /common/rs/ajax.jsp(276,16) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
