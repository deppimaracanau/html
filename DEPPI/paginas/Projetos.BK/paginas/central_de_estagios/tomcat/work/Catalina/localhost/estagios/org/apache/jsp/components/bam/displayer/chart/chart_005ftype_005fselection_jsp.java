...
public final class chart_005ftype_005fselection_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /components/bam/displayer/chart/chart_type_selection.jsp(26,0) name = baseName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fbundle_005f0.setBaseName("org.jboss.dashboard.displayer.messages");
        // /components/bam/displayer/chart/chart_type_selection.jsp(26,0) name = locale type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (renderer.isFeatureSupported(displayer, DataDisplayerFeature.SET_CHART_TYPE)) {
      ...
      try {
        ...
        // /components/bam/displayer/chart/chart_type_selection.jsp(37,8) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fmessage_005f0.setKey( AbstractChartDisplayerEditor.I18N_PREFFIX + "type");
      ...
      out.print( renderer.getChartTypeDescription(displayer.getType(), locale) );
      out.write("\" name='chartType' id='<factory:encode name=\"chartType\"/>'\n");
