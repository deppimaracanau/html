				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form method="post" action="../../models/dados/laboratorio.php">
							...
							<label for="email">Responsáveis pelo laboratório</label>
							<input type="text" class="form-control" id="responsavel" name="responsavel">
							<br>
							<label for="apresentacao">Texto</label>
							<textarea type="text" class="form-control" id="apresentacao" name="apresentacao"> </textarea>
							<br>

  							<label for="cursos">Numero de Colunas</label>
