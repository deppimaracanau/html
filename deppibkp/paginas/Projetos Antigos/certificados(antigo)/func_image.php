...
//Mudar imagem de fundo
	...
	$text_certificado = 'Certificamos que '.strtoupper(trim($arquivo1[$i])).' participou da Mesa redonda: Meu Primeiro dia de aula, promovida pelo Projeto PAID (Palestras para Apresentar, Integrar e Desenvolver a Química), com carga horária de 3 horas.';
...
*/
	...
	*/
	...
	header('Content-Disposition: filename="'. $basename .'.jpg"'); //Nome da imagem gerada
  	//imagejpeg($im);
	header("Location:./index.html"); //Mandar para página galeria???
