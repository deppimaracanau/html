 ...
 * Generated at: 2017-10-09 00:06:28 UTC
...
public final class nvd3_005flinechart_005fviewer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/components/bam/displayer/chart/nvd3_linechart_script.jsp", Long.valueOf(1460669778000L));
 ...
 if( enableDrillDown ) { 
      ...
      try {
        ...
        // /components/bam/displayer/chart/nvd3_linechart_viewer.jsp(60,2) name = bean type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_factory_005fhandler_005f0.setBean(viewer.getBeanName());
        // /components/bam/displayer/chart/nvd3_linechart_viewer.jsp(60,2) name = action type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if( displayer.isShowTitle() && displayer.getTitle() != null) { 
    ...
    if (displayer.isAxisInteger()) decimalPrecision = 0;
      ...
      out.write("        {\n");
      out.write("            key: \"");
      out.print( displayer.getTitle() != null ? displayer.getTitle() : "" );
      out.write("\",\n");
      out.write("            area: ");
      out.print( displayer.isShowLinesArea());
      out.write(",\n");
      out.write("            color: \"");
 ...
 for(int i=0; i < xvalues.size(); i++) { if( i != 0 ) out.print(", "); 
      ...
      out.write("            var chart = nv.models.lineChart();\n");
      out.write("\n");
      out.write("            chart\n");
      out.write("                .x(function(d) { return d.x })\n");
      out.write("                .y(function(d) { return d.y })\n");
      out.write("                .width(");
      out.print( displayer.getWidth() );
      out.write(")\n");
      out.write("                .height(");
      ...
      out.write("                    if( (typeof d === 'number' && d % 1 == 0) && d >= 0 && d < ");
      out.print(xvalues.size());
      out.write(" )\n");
      out.write("                        return ");
      out.print( displayer.isShowLabelsXAxis() ? "chartLabels" + chartId + "[d]" : "" );
      out.write("\n");
      out.write("                    else\n");
      out.write("                        return \"\";\n");
      out.write("                   });\n");
 ...
 if(!enableTooltips) { 
      out.write("\n");
      out.write("            chart.tooltips(false);\n");
 } 
      out.write("\n");
      out.write("            d3.select('#");
      out.print( chartId );
 ...
 if( enableDrillDown ) {
      out.write("\n");
      out.write("    graph.lines.dispatch.on('elementClick', function(e) {\n");
      ...
      out.write("       y = graph.yAxis.tickFormat()(graph.lines.y()(e.point, e.pointIndex));\n");
      out.write("       n = e.pointIndex;\n");
      out.write("\n");
      out.write("       if( n >= 0 && n < ");
      out.print(xvalues.size());
      out.write(" ) {\n");
      out.write("           content = chartLabels");
      out.print(chartId);
      out.write("[n] + \" : \" + y;\n");
      out.write("       } else {\n");
      out.write("           content = \"\";\n");
  ...
  private boolean _jspx_meth_factory_005fformUrl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /components/bam/displayer/chart/nvd3_linechart_viewer.jsp(59,28) name = friendly type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
