...
import org.jboss.dashboard.ui.components.chart.AbstractXAxisDisplayerEditor;
...
public final class xaxis_005fproperties_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      try {
        ...
        // /components/bam/displayer/chart/xaxis_properties.jsp(25,0) name = baseName type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fbundle_005f0.setBaseName("org.jboss.dashboard.displayer.messages");
        // /components/bam/displayer/chart/xaxis_properties.jsp(25,0) name = locale type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (renderer.isFeatureSupported(displayer, DataDisplayerFeature.SHOW_HIDE_LABELS)) { 
      ...
      try {
        ...
        // /components/bam/displayer/chart/xaxis_properties.jsp(34,4) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fmessage_005f0.setKey( AbstractChartDisplayerEditor.I18N_PREFFIX + "showLabels");
      ...
      out.write(":\n");
      out.write("  </td>\n");
      out.write("  <td height=\"15\" align=\"left\">\n");
      out.write("    <input name=\"showLabelsXAxis\" type=\"checkbox\" value=\"true\" ");
      out.print(displayer.isShowLabelsXAxis() ? "checked" : "");
      out.write("\n");
 ...
 if (renderer.isFeatureSupported(displayer, DataDisplayerFeature.SET_LABELS_ANGLE)) { 
      ...
      try {
        ...
        // /components/bam/displayer/chart/xaxis_properties.jsp(46,4) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fmessage_005f1.setKey( AbstractChartDisplayerEditor.I18N_PREFFIX + "labelAngleXAxis");
      ...
      out.write("    <input class=\"skn-input\" name=\"labelAngleXAxis\" type=\"text\" size=\"14\" value=\"");
 ...
 if (renderer.isFeatureSupported(displayer, DataDisplayerFeature.SHOW_LINES_AREA)) { 
      ...
      try {
        ...
        // /components/bam/displayer/chart/xaxis_properties.jsp(57,8) name = key type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_i18n_005fmessage_005f2.setKey( AbstractChartDisplayerEditor.I18N_PREFFIX + "showLinesArea");
      ...
      out.write("\n");
      out.write("        <input name=\"showLinesAreas\" type=\"checkbox\" value=\"true\" ");
      out.print(showLinesArea ? "checked" : "");
      out.write("\n");
      out.write("               onClick=\"return bam_kpiedit_submitProperties(this);\">\n");
      out.write("    </td>\n");
      out.write("</tr>\n");
 } 
      out.write('\n');
