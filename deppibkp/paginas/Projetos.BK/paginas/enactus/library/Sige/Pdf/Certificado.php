...
class Sige_Pdf_Certificado {
   ...
   /* const NUM_MAX_CARACTERES = 80;
    ...
    const DES_X = 220;*/
	 ...
	 const NUM_MAX_CARACTERES = 80;
    const POS_X_INICIAL = 170;
    const POS_Y_INICIAL = 370;
    const DES_Y = 20;
    const TAM_FONTE = 15;
    const POS_X1_INI_ASSINATURA = 130;
    const POS_X2_INI_ASSINATURA = 260;
    const POS_Y1_ASSINATURA = 80;
    const POS_Y2_ASSINATURA = 160;
    const DES_X = 220;
    ...
    $array = array(
        ...
        $array["carga_horaria"] = floor($array["carga_horaria"]);
        $paragrafo = "      ";
        $texto = sprintf(
    ...
    )
    {
        ...
        $paragrafo = "      ";
        $texto = sprintf(
            $paragrafo . $encontro_obj["certificados_template_participante_evento"],
            $this->fullUpper($array['nome']),
            $array['nome_tipo_evento'],
            $array['nome_evento'],
            $array["carga_horaria"],
            $array['encontro']
        );
