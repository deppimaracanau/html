<?php
	...
	$mail->Port = 465; //porta de conexão
	...
	$mail->Username = 'formulario.pesquisa.2018.ifce@gmail.com'; //usuário do smtp (email cadastrado no servidor)
	$mail->Password = 'd3pp1d3pp12018'; //senha ****CUIDADO PARA NÃO EXPOR ESSA INFORMAÇÃO NA INTERNET OU NO FÓRUM DE DÚVIDAS DO CURSO****
	
	//dados de envio de e-mail
	$mail->addAddress('diego-dlp@hotmail.com', 'Jorge Teste'); //e-mails que receberam a mesagem
