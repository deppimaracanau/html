<?php 
	...
	if($conexao == null) {
		...
		if($_POST['idEmpresa'] != "") { 
			...
			$sql = pg_query("UPDATE empresa SET nome_empresa = '$nomeEmpresa', rua = '$ruaEmpresa', complemento = '$complemento', id_bairro = '$bairro', email_empresa = '$emailEmpresa', telefone_empresa = '$telefone', responsavel = '$responsavel' WHERE id_empresa = '$idEmpresa';")
