...
$smtp->user = "cicerosilva.ifce@gmail.com"; //Conta de email
$smtp->pass = "c1c3ru@silva#!"; //Senha da Conta de e-mail.
$smtp->debug = TRUE; //Somente para usuários avançados que desejam o log do envio para testes.
//#########################################
// Envio do formulário
//#########################################
$to = "cicerosilva.ifce@gmail.com"; //Informe aqui o e-mail que deve receber a mensagem do formulário.
$from = $email;
