        ...
        var a = e(window).width(),
            ...
            c = function () {
                ...
                "all" == o.settings.preloadImages && (s = r.children()),
                    o.settings.ticker
                        ? (o.settings.pager = !1)
                        : (o.settings.pager && w(), o.settings.controls && T(), o.settings.auto && o.settings.autoControls && C(), (o.settings.controls || o.settings.autoControls || o.settings.pager) && o.viewport.after(o.controls.el)),
                    s.imagesLoaded(g);
            },
            g = function () {
                o.loader.remove(),
            ...
            p = function () {
                ...
                return (
                    0 == o.settings.slideWidth || (o.settings.slideWidth > t && !o.carousel) || "vertical" == o.settings.mode
                        ? (e = t)
                        : o.settings.maxSlides > 1 && "horizontal" == o.settings.mode && (t > o.maxThreshold || (o.minThreshold > t && (e = (t - o.settings.slideMargin * (o.settings.minSlides - 1)) / o.settings.minSlides))),
                    e
                );
            },
            v = function () {
            ...
            w = function () {
                o.settings.pagerCustom
                    ...
                    : ((o.pagerEl = e('<div class="bx-pager" />')), o.settings.pagerSelector ? e(o.settings.pagerSelector).html(o.pagerEl) : o.controls.el.addClass("bx-has-pager").append(o.pagerEl), b()),
            ...
            M = function (t) {
                return "short" == o.settings.pagerType
                    ? (o.pagerEl.html(t + 1 + o.settings.pagerShortSeparator + o.children.length), void 0)
            ...
            I = function () {
                if (o.settings.infiniteLoop) {
                    ...
                    0 == o.active.index
                        ...
                        : o.active.index == f() - 1 && o.carousel
                        ? (e = o.children.eq((f() - 1) * x()).position())
            ...
            X = function (e) {
                ...
                if (((o.touch.end.x = t.changedTouches[0].pageX), (o.touch.end.y = t.changedTouches[0].pageY), "fade" == o.settings.mode)) {
                    ...
                    "horizontal" == o.settings.mode ? ((n = o.touch.end.x - o.touch.start.x), (i = o.touch.originalPos.left)) : ((n = o.touch.end.y - o.touch.start.y), (i = o.touch.originalPos.top)),
                        !o.settings.infiniteLoop && ((0 == o.active.index && n > 0) || (o.active.last && 0 > n))
                            ? S(i, "reset", 200)
    ...
    (function (e, t) {
        ...
        e.fn.imagesLoaded = function (n) {
            ...
            function o(t, n) {
                t.src === i ||
                    -1 !== e.inArray(t, c) ||
                    (c.push(t), n ? h.push(t) : g.push(t), e.data(t, "imagesLoaded", { isBroken: n, src: t.src }), l && a.notifyWith(e(t), [n, d, e(g), e(h)]), d.length === c.length && (setTimeout(s), d.unbind(".imagesLoaded")));
            }
            var r = this,
