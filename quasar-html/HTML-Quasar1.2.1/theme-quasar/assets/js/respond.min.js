...
(function (a) {
    ...
    var b = {};
    (a.respond = b), (b.update = function () {}), (b.mediaQueriesSupported = a.matchMedia && a.matchMedia("only all").matches), b.mediaQueriesSupported;
    var q,
        r,
        t,
        c = a.document,
            ...
            for (var p in e)
                if (e.hasOwnProperty(p)) {
                    ...
                    w && (w = parseFloat(w) * (w.indexOf(A) > -1 ? t || s() : 1)),
                        ...
                        (v.hasquery && ((y && z) || !(y || k >= w) || !(z || x >= k))) || (m[v.media] || (m[v.media] = []), m[v.media].push(f[v.rules]));
                }
