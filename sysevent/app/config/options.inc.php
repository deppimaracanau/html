...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "3.2");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "28");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.2.2");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "phpeventcalendar_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjLog', 'pjInstaller', 'pjBackup', 'pjOneAdmin');
?>