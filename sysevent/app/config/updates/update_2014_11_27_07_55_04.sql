...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'You can export events in different formats. You can either download a file with events details or use a link for a feed which load all the events.', 'script');
...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Events', 'script');
...
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Events Feed URL', 'script');

INSERT INTO `fields` VALUES (NULL, 'infoEventFeedDesc', 'backend', 'Infobox / Events Feed URL', 'script', NULL);

SET @id := (SELECT LAST_INSERT_ID());

INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Use the URL below to have access to all events. Please, note that if you change the password the URL will change too as password is used in the URL itself so no one else can open it.', 'script');
